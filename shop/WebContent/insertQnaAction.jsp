...
<%
	...
	// 방어코드
	if(request.getParameter("category")=="" || request.getParameter("category")==null || request.getParameter("title")=="" || request.getParameter("title")==null || request.getParameter("content")=="" || request.getParameter("content")==null){
